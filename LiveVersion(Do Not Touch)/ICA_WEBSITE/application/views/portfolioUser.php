...
<section>
  ...
  <div class="row">
    ...
    <div class="col-lg-2">
      <img src="<?=$portfolioImage?>" class="rounded userPortfolio" alt="portfolioImg">
...
<?=anchor('portfolio/deleteProfile','Delete',array('class' => 'btn btn-outline-secondary portfolioDeleteButton','target' => '_self'))?>
      </div>
      <div class="col-lg-1">
      </div>
      <div class="col-lg-5">
